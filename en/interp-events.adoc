...
| `watch <word1> <word2>...`  | n/a | Watch one or more words. `w` can be used as shortcut for `watch`.
| `-watch <word1> <word2>...` | n/a | Stop watching one or more words. `-w` can be used as shortcut for `-watch`.
