...
|*`ENTER`* | `any-block!`  | -1     |  n/a (`none`) | n/a (`none`) | when a block is about to be evaluated.
|*`EXIT`*  | `any-block!`  | -1     |  n/a (`none`) | n/a (`none`) | when current evaluated block's tail has been reached.
