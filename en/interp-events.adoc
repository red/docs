...
|*`PROLOG`*| `block!`, `paren!` | -1     |  called `function!` value | `word!`, `path!` | when entering a function.
|*`EPILOG`*| `block!`, `paren!` | -1     |  called `function!` value | `word!`, `path!` | when exiting a function.
