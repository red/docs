...
The `shape` keywords gives access to the Shape sub-dialect drawing commands. This sub-dialect provides an alternative API to some basic drawing commands.

NOTE: Absolute vs relative coordinates...
