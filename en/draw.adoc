...
<start>    : (optional, default: 0x0) upper corner for crop section within internal image (pair!).
<end>      : (optional, default: <size>) lower corner for crop section within internal image (pair!).
...
<start> : (optional, default: 0x0) upper corner for crop section within image (pair!)
<end>   : (optional, default: <image> size) lower corner for crop section within image (pair!)
<mode>  : (optional) tile mode. (word!).
----
