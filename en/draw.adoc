...
This command defines the outlines drawing mode for other commands. Many different options are possible from a simple color, to nested custom shapes and gradients.
...
This command defines the filling mode for other commands requiring filling operations (closed shapes). Many different options are possible from a simple color, to nested custom shapes and gradients.
...
When the `pen` or `fill-pen` words are used, the rotation is applied respectively to the current pen or current fill-pen.
...
When the `pen` or `fill-pen` words are used, the scaling is applied respectively to the current pen or current fill-pen.
...
When the `pen` or `fill-pen` words are used, the translation is applied respectively to the current pen or current fill-pen.
...
When the `pen` or `fill-pen` words are used, the skewing is applied respectively to the current pen or current fill-pen.
