...
Typesets represents sets, or collections, of `datatype!` values.

The datatypes in a typeset may share common traits or behaviors, but that is not a requirement. You can create your own typesets based on any criteria that suits your needs.
