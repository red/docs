...
`Char!` values represent a Unicode code point. It is an integer number in the range hexadecimal 00 to hexadecimal 10FFFF. (0 to 1,114,111 in decimal.) 
...
----
#"<character>"
<character> : UTF-8 encoding for a single Unicode codepoint
----
