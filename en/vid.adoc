...
Sets the face's `font` facet to a new `font!` object. Font! object is described [here](view.html#_font_object).
...
Sets the face's `para` facet to a new `para!` object. Para! object is described [here](view.html#_para_object).
