...
V této oblasti kódu je také možné definovat aktéry kontejneru - viz sekci <<Aktéři>>.
...
Aby bylo možné vyhovět odlišným UI požadavkům různých platforem GUI, vkládá VID přepisovací strojek, schopný dynamické úpravy stromu piškotů (face tree) podle zadaných pravidel. Je zařazen jako poslední stupeň procesu VID.
