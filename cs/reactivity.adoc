...
|*reaktivní programování* | Programovací paradigma, podmnožina programování toku dat, založené na událostech, které "push" (posílají) změny.
...
|*reaktivní objekt* | Objekt, jehož pole mohou byt použita jako reaktivní zdroje.
